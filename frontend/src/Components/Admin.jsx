...
const fetchPendingUsers = () => authFetch('http://authentication-system-deployment-api.vercel.app/api/auth/pending', { method: 'GET' })

const approveUser = (userId) => authFetch(`http://authentication-system-deployment-api.vercel.app/api/auth/approve/${userId}`, { method: 'PUT' })
